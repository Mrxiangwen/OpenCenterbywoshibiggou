...
<div class="panel-main" style="float:left;">
    ...
    <div class="with-padding clearfix">
        ...
        <div class="pull-right">
            <a href="<?php echo U('Theme/tpls',array_merge($_GET,array('refresh'=>1)));?>" class="btn btn-success"><i class="icon-undo"></i> <?php echo L("_CHECK_FOR_UPDATES_IMMEDIATELY_");?></a>
        </div>
    </div>
            ...
            <div style="width: 270px;padding: 0 10px;float: left;">
                <div class="card">
                    <div class="media-wrapper">
                        <img src="/opencenter/Public/images/preview.jpg" style="height: 180px;">
                    </div>
                    ...
                    <div class="card-heading">
                        ...
                        <a href="<?php echo U('Admin/Theme/lookTheme',array('theme'=>'default'));?>" target="_blank" title=<?php echo L("_CHECK_THE_THEME_WITH_DOUBLE_");?>>
                            <strong>OpenCenter V2<?php echo L("_SYSTEM_DEFAULT_THEME_");?></strong>
                        </a>
                    </div>
