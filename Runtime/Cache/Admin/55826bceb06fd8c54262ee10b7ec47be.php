...
<div class="panel-main" style="float:left;">
	...
	<div class="main-title">
		<h2><?php echo L("_BEHAVIOR_LOG_");?>&nbsp;&nbsp;&nbsp;<sub style="color: red"><?php echo L("_THE_LONGTERM_ACCUMULATION_OF_BEHAVIOR_LOG_WILL_LEAD_TO_THE_WHOLE_SYSTEM_PERFORMANCE_DEGRADATION_");?></sub></h2>
	</div>
    <div class="clearfix">
        <div class="col-xs-8">
                <button class="btn ajax-get confirm" url="<?php echo U('clear');?>"><?php echo L("_CLEARANCE_WITH_SPACE_");?></button>
                <button class="btn ajax-post confirm" target-form="ids" url="<?php echo U('remove');?>"><?php echo L("_DELETE_WITH_SPACE_");?></button>
        </div>
    ...
    <thead>
		...
		<th class=""><?php echo L("_BEHAVIOR_NAME_");?></th>
		<th class=""><?php echo L("_EXECUTIVE_");?></th>
        <th class=""><?php echo L("_LOG_CONTENT_");?></th>
		<th class=""><?php echo L("_EXECUTION_TIME_");?></th>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('Action/edit?id='.$vo['id']);?>"><?php echo L("_DETAILED_");?></a>
				<a class="confirm ajax-get" href="<?php echo U('Action/remove?ids='.$vo['id']);?>"><?php echo L("_DELETE_");?></a>
                </td>
