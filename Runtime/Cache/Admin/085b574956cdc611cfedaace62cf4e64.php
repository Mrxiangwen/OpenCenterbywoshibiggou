                ...
                <div class="bd">
                    <div class="">
                        <table class="table table-bordered table-striped ">
                            ...
                            <tr>
                                <th><?php echo L('_OC_VERSION_');?></th>
                                <td><?php echo file_get_contents('./Data/version.ini');?></td>
                            </tr>
                            <tr>
                                <th><?php echo L('_OC_QQ_GROUP_');?></th>
                                <td>390967955</td>
                            </tr>
                        </table>
                    </div>
...
<script type="text/javascript">
    ...
    <script type="text/javascript" src="/opencenter/Application/Admin/Static/js/highcharts.js"></script>
    ...
    <script>
        $('[data-role=saveCountSetting]').click(function () {
            $.post("/opencenter/index.php?s=/admin/index/index.html", {count_day: $('[name=count_day]').val()}, function (msg) {
                handleAjax(msg);
            });
        })
    </script>
