    ...
    <table class="table table-bordered table-striped ">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$e): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    ...
                    <a href="<?php echo U('admin/expression/editpackage',array('name'=>$e['name']));?>"><?php echo L("_EDIT_");?></a>&nbsp;|&nbsp;<a class="ajax-get" href="<?php echo U('admin/expression/delpackage',array('name'=>$e['name']));?>"><?php echo L("_DELETE_");?></a>
                    <?php } ?>
                </td>
