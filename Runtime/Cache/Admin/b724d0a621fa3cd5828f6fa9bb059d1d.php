...
<?php switch($field["type"]): case "text": ?><input type="text" name="<?php echo ($field["name"]); ?>" value="<?php echo (htmlspecialchars($field["value"])); ?>"
    ...
    <?php case "icon": ?><div class='icon-chose' title=<?php echo L("_SELECT_ICON_WITH_DOUBLE_");?> style="width: 400px;">
        ...
        <script src="/opencenter/Application/Admin/Static/zui/lib/chosen/chosen.icons.min.js"></script>
        <link href="/opencenter/Application/Admin/Static/zui/lib/chosen/chosen.icons.css" rel="stylesheet">
        <?php } ?>
        <script>
            $(function(){
...
<script type="text/javascript">
    ...
    <?php if($importDatetimePicker): ?><link href="/opencenter/Application/Admin/Static/zui/lib/datetimepicker/datetimepicker.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="/opencenter/Application/Admin/Static/zui/lib/datetimepicker/datetimepicker.min.js"></script>
    ...
    <?php if($colorPicker): ?><script type="text/javascript" src="/opencenter/Application/Admin/Static/js/jquery.simple-color.js"></script>
        <script>
            $(function(){
    ...
    <script type="text/javascript" charset="utf-8" src="/opencenter/Public/js/ext/webuploader/js/webuploader.js"></script>
    <link href="/opencenter/Public/js/ext/webuploader/css/webuploader.css" type="text/css" rel="stylesheet">
